...
export class SentinelSectionComponent
  implements OnInit, OnDestroy, ControlValueAccessor, Validator {
  @Input() set sentinel(sentinel: SentinelSection) {
    this._sentinel = sentinel;
    this.selectedFc.setValue(
      this._sentinelSearchQuery.isSentinelSelected(sentinel.name),
      {emitEvent: false}
    );
  }
  ...
  ngOnInit(): void {
    this.visible$ = this._sentinelSearchQuery.selectVisibleSentinels().pipe(
      untilDestroyed(this),
