...
export function getBaseUrlAndParamsFrom(url: string): {url: string, [param: string]: any} {
  ...
  const params = urlBaseAndParams[1];
  return {url: urlBase, ..._extractParamsMapFrom(params)};
}
