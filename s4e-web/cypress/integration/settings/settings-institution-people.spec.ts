...
describe('Inviting people', () => {
  ...
  context("Accept invitation to institution", () => {
    ...
    it('should invite and add to institution registered person with administrator privileges', function () {
      ...
      SettingsInstitutionPeople
        .goToPeopleInInstitutionPage()
        .addInvitation(this.userToRegister.email, true)
        .invitationWithEmailShouldExist(this.userToRegister.email)
      SettingsNav
        .logOut()
      ...
      UserOptionsGoToSettings
        .gotoUserProfile();
      SettingsNav
        .institutionNavigationShouldHaveValue("exist");
      SettingsInstitutions
        .selectNthInstitution(0)
        .addChildAndEditInstitutionShould("exist");
      SettingsNav
        .goToUserProfile();
      SettingsUserDeleteAccount
        .deleteAccount(this.userToRegister.password);
    ...
    it.only('should invite, re-invite and remove person from the institution', function () {
      Login
        .goToRegisterPage();
      Registration
        .registerAs(this.userToRegister);
      ...
      SettingsInstitutionPeople
        ...
        .addInvitation(this.userToRegister.email, false)
        .invitationWithEmailShouldExist(this.userToRegister.email)
      // .resendToNewEmail(this.userToRegister.email);
      SettingsNav
        .logOut();
      ...
      SettingsInstitutionPeople
        .goToPeopleInInstitutionPage()
        .removeFromInstitution(this.userToRegister.email);
      ConfirmModal
        .accept();
      SettingsNav
        .logOut();
      ...
      UserOptionsGoToSettings
        .gotoUserProfile()
      SettingsInstitutions
        .allInstititutionCountShouldBe(0);
      SettingsNav
        .goToUserProfile();
      SettingsUserDeleteAccount
        .deleteAccount(this.userToRegister.password);
  ...
  context("Reject invitation to institution", () => {
    ...
    it('should reject invite to institution', function () {
      ...
      cy.clickRejectJoinToInstitutionLink()
      cy.visit("/login");
  ...
  context("Administrator privileges", () => {
    ...
    it('should add and delete administrator privileges person belong to institution', function () {
      ...
      UserOptionsGoToSettings
        .gotoUserProfile();
      SettingsNav
        .institutionNavigationShouldHaveValue("not.exist");
      SettingsInstitutions
        .selectNthInstitution(0)
        .addChildAndEditInstitutionShould("not.exist");
      SettingsNav
        .logOut();
      Login
        .loginAs(this.zkAdmin);
